...
app.post('/api/login', async (req, res) => {
  try {
    ...
    if (email === 'muhammedashif0112@gmail.com' && password === 'Ashif@0112') {
      return res.json({ message: 'Login successful', user: { name: 'Admin', email: 'muhammedashif0112@gmail.com', role: 'admin' } });
    }
